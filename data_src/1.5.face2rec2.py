...
def image_encode(args, i, item, q_out):
    ...
    if item.flag==0:
      ...
      header = mx.recordio.IRHeader(item.flag, item.label, item.id, 0)
      print('write', item.flag, item.id, item.label)
      print('type(label)', type(item.label))
...
def parse_args():
    ...
    # parser.add_argument('--prefix', default = '../data/small_vgg',help='prefix of input/output lst and rec files.')
    # parser.add_argument('--root', default = '../data/small_vgg/small_vgg_112x112',help='path to folder containing images.')
    parser.add_argument('--prefix', default = '../data/my_vgg',help='prefix of input/output lst and rec files.')
    parser.add_argument('--root', default = '../data/my_vgg/align_vgg',help='path to folder containing images.')
