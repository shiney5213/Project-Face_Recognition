...
def parse_args():
    ...
    parser.add_argument('--prefix', default ='../data/small_vgg/train/',help='prefix of input/output lst and rec files.')
    parser.add_argument('--root', default ='./data/small_vgg/train',help='path to folder containing images.')
