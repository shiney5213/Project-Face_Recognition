...
if __name__ == '__main__':
    ...
    # parser.add_argument('--train_root', type=str, default='', help='train image root')
    # parser.add_argument('--train_file_list', type=str, default='../data/small_vgg/small_vgg_', help='train list')
    parser.add_argument('--train_root', type=str, default='', help='train image root')
    parser.add_argument('--train_file_list', type=str, default='../data/faces_webface_112x112/train.lst', help='train list')
